...
df = df[["Input_Roller_Bearing", "Output_Duplex_Bearing"]]
data_train = df['Output_Duplex_Bearing']

df1 = pd.read_csv("GB_TempFault1.csv", na_filter=False)
df1 = df1[["Input_Roller_Bearing", "Output_Duplex_Bearing"]]
data_test = df1['Output_Duplex_Bearing']
...
plt.xlabel('Time (s)')
plt.ylabel('Output_Duplex_Bearing')
plt.title('Output_Duplex_Bearing vs. Time')
